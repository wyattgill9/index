...
pub fn render_units_nix(graph: &UnitGraph, options: &RenderOptions) -> Result<String> {
    ...
    out.push_str("# Generated by nix-cargo-unit. Do not edit by hand.\n");
    out.push_str(
    ...
    out.push_str("    env = (attrs.env or {}) // extraEnv;\n");
    out.push_str("  });\n\n");
    out.push_str("  units = rec {\n");
    ...
    out.push_str("  } // extraPolicyChecks;\n");
    out.push_str("  withPolicyChecks = package:\n");
    out.push_str("    if policyChecks == {} then package else pkgs.symlinkJoin {\n");
    out.push_str("      name = \"${package.name}-policy-checked\";\n");
    out.push_str("      paths = [ package ];\n");
    out.push_str("      passthru = { unchecked = package; inherit policyChecks; };\n");
    out.push_str("      postBuild = ''\n");
    out.push_str("        mkdir -p \"$out/cargo-unit-policy\"\n");
    out.push_str(
    ...
    out.push_str("in\n");
    out.push_str("{\n");
    out.push_str("  inherit policyChecks units;\n");
    writeln!(out, "  roots = [ {} ];", render_roots(graph, &prepared))?;
    writeln!(
        out,
        "  checkedRoots = [ {} ];",
        render_checked_roots(graph, &prepared)
    )?;
    write!(
        out,
        "  packages = {{\n{}  }};\n",
